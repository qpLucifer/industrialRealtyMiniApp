...
/** Removed keyboard scroll composable — DevTools cache may still require this path. */
const legacyFormScrollFocus = `"use strict";
function noop() {}
exports.useFormScrollFocus = function useFormScrollFocus() {
  return {
    scrollIntoView: { value: "" },
    scrollTop: { value: 0 },
    keyboardPadPx: { value: 0 },
    keyboardPadStyle: {},
    focusField: noop,
    clearScrollTarget: noop,
    onScrollViewScroll: noop,
  };
};
exports.nextFormFieldAnchor = function nextFormFieldAnchor(prefix) {
  return (prefix || "ff") + "-stub";
};
`
write(path.join(composablesDir, 'useFormScrollFocus.js'), legacyFormScrollFocus)
...
if (scrubbed) {
  console.log(`[mp-weixin-compat-shims] scrubbed stale usingComponents from ${scrubbed} page json file(s)`)
}
